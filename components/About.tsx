...
const quickData = [
  ...
  { k: 'Industrias', v: 'Fintech · SaaS · Retail · Marketplace · Wellness' },
  { k: 'Público', v: 'Founder · C Level · Lead · Ssr' },
          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
              ...
              <a
                ...
                style={{ fontSize: 14, padding: '11px 20px', borderRadius: 999, border: '1px solid var(--line)', color: 'var(--ink-2)' }}
              >
                Seguime en LinkedIn
              </a>
            </div>
